		...
		<dl>
			<?php if( $amount = \get_post_meta( $post_id, 'amount', true ) ) : ?>
				...
				<dd class="purchase-agreement__amount entry-value">
					<?php \printf( '<span class="currency-symbol">%s</span><span class="value">%s</span>', __( '$', 'debtcollecollective' ), SiteFunctionality\convert_string_to_number( $amount ) ); ?>
				</dd>
			<?php endif; ?>
			...
			<?php if( $number = \get_post_meta( $post_id, 'number', true ) ) : ?>
				...
				<dd class="purchase-agreement__number entry-value">
					<?php printf( '<span class="value">%s</span>', SiteFunctionality\convert_string_to_number( $number, false ) ); ?>
				</dd>
			<?php endif; ?>
			<?php if( $average = \get_post_meta( $post_id, 'average', true ) ) : ?>
				...
				<dd class="purchase-agreement__average entry-value">
					<?php printf( '<span class="currency-symbol">%s</span><span class="value">%s</span>', __( '$', 'debtcollecollective' ), SiteFunctionality\convert_string_to_number( $average ) ); ?>
				</dd>
			<?php endif; ?>
			<?php if( $purchase_price = \get_post_meta( $post_id, 'price', true ) ) : ?>
				...
				<dd class="purchase-agreement__purchase-price entry-value">
					<?php printf( '<span class="currency-symbol">%s</span><span class="value">%s</span>', __( '$', 'debtcollecollective' ), SiteFunctionality\convert_string_to_number( $purchase_price ) ); ?>
				</dd>
			<?php endif; ?>
		</dl>
